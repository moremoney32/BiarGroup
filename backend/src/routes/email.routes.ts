...
router.get('/smtp',                   rbacMiddleware(['client', 'admin', 'super_admin']), emailController.getSmtpConfigs)
router.post('/smtp',                  rbacMiddleware(['client', 'admin', 'super_admin']), emailController.createSmtpConfig)
router.put('/smtp/:id',               rbacMiddleware(['client', 'admin', 'super_admin']), emailController.updateSmtpConfig)
router.delete('/smtp/:id',            rbacMiddleware(['client', 'admin', 'super_admin']), emailController.deleteSmtpConfig)
router.patch('/smtp/:id/default',     rbacMiddleware(['client', 'admin', 'super_admin']), emailController.setSmtpDefault)
router.post('/smtp/:id/verify',       rbacMiddleware(['client', 'admin', 'super_admin']), emailController.verifySmtpConfig)
